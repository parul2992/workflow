...
<!--                   <li><a class="menu" href="#templatemo_service_page">Services</a></li> -->
                  <li><a class="menu" href="WorkLoad.jsp">GO BACK</a></li>
...
<div class="templatemo_team_wrapper" id="templatemo_team_page">
  <div class="container">
    <div class="row">
      ...
      <p><font face="verdana" color="#FF00FF"><h3> <marquee scrollamount="5" width="40"></marquee> FILE WORKLOAD
...
<!--       <h1>FILE WORKLOAD</h1> -->
      ...
      <br>
			...
			PreparedStatement ps=(PreparedStatement)c.prepareStatement("SELECT * FROM `workflowscheduling`.`workloaddetails` where filetitile='"+ftitile+"'");
			...
			%>
			 ...
			 <center>
			 <table border="2" style="position:relative;left:10px; background-color: #A9F5F2">
...
while(rs.next())
{
	...
	String filetitile=rs.getString(2);
	String cash=rs.getString(3);
	...
	String filepath=rs.getString(6);
			...
			%>
                    ...
                    <tr>
                   <td height="50"><%= Fileid%></td> 
                   <td><%=filetitile %></td> 
                   <td><%=cash %>	</td>
                   <td><%=filename %></td>
<!--                     <td><a href="AssignWorkSchedule.jsp">Assign Schedule</a></td> -->
                     <td><a href="ProviderWelocomepage.jsp">Assign Schedule</a></td>
                   </tr>
