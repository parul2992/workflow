            ...
            <div id="top-menu">
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a class="menu" href="#templatemo_service_page"></a></li>
                  <li><a class="menu" href="index.jsp">Back</a></li>
               
                  <li><a class="menu" href="#templatemo_contact_page"></a></li>
...
String creadit="UNO";
            		...
            		final String random=""+creadit+s1+s2+s3+s4+s5;
            		
            		System.out.println("Randam========="+random);
...
<div class="templatemo_servicewrapper" id="templatemo_service_page">
  <div class="container">
<!--     <div class="row"> -->
      <h3 style="color: navy;">Sign Up</h3></div>
  
    <form action="UserRegisteration" method="post">
    
     UserId:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="UserId" value="<%=random %>" placeholder="User ID" ><br>
    UserName:&nbsp;&nbsp;&nbsp;<input type="text" name="UserName"  placeholder="User Name" ><br>
   Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="Psssword" placeholder="PassWord"><br>
    FatherName:<input type="text" name="fathername" placeholder="Father Name"><br>
   Country:&nbsp;&nbsp;<select name="Country"> <option >Select</option>
    ...
    <option value="America">America</option>
      ...
      DateOfBirth:&nbsp;<input type="date" name="Dob"  placeholder="Date of birth" ><br>
        Gender:&nbsp;&nbsp;<input type="radio" name="gender" value="Male">Male&nbsp;&nbsp;<input type="radio" name="gender" value="Female">Female<br>
        Email-Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" name="email"  placeholder="Email-Id" ><br>
