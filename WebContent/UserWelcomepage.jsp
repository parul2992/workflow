...
<!--                        <li><a class="menu" href="ProviderLogin.jsp">Cloud Provider</a></li> -->
                  <li><a class="menu" href="UserSendRequest.jsp">Send Request</a></li>
                  <li><a class="menu" href="RecieveWorkScheduled.jsp">DownloadWorkScheduled</a></li>
...
<br>
      			...
      			<%//String ftitile=request.getParameter("Username");
         		//	String uid=session.getAttribute("Uid").toString();
      			...
      			String uid=session.getAttribute("userid").toString();
        			...
        			PreparedStatement ps=(PreparedStatement)c.prepareStatement("SELECT username,userid,status FROM `workflowscheduling`.`userregistration` where userid='"+uid+"' ");
...
// //         	   {
                   ...
                   <marquee> YOUR USER ID IS:       <td height="50"><%= userid%></td> </marquee>
<%--                            <td><%=status %></td>  --%>
...
<center> Your Status IS== <td style="position:relative;background-color:#ADFF2F"><%=status %></td></center> 


<%--    <%=session.getAttribute("Status") %></td></center> --%>
