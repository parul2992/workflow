...
<!--  <h3>WELCOME::: ADMIN</h3> -->
  ...
  <h1>USER DETAILS</h1>
      ...
      <br>
			...
			PreparedStatement ps=(PreparedStatement)c.prepareStatement("SELECT * FROM `workflowscheduling`.`userregistration` where status='accept'");
...
// 	   {
			%>
                   ...
                   <td><%=username %></td> 
                   <td><%=emailid %>	</td>
<%--                    <td><a href="UpdateServlet?patid=<%= %>"><img alt="" src="images/reject.gif"></td></a>   --%>
                    
                    <input type="hidden" value="<%= userid%>" name="userid">
                    
                    
                    <td style="position:relative;background-color:#00CED1"><%=status %></form> 	</td>
                 <%  HttpSession session1=request.getSession();
                 session1.setAttribute("Session1value", status);
                 %>
                   </tr>
<%--                     <%}else { %> --%>
<!--                      <tr> -->
...
<%--                    <td><%=username %></td>  --%>
<%--                    <td><%=emailid %>	</td> --%>
<!--                   <td><a href=""><img alt="" src="images/accept.gif"></td></a>      -->
