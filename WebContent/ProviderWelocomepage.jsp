...
<style type="text/css">
  ...
  li ul {display: none;}
  ul li a {display: block;background:url(../images/header.jpg) 0 bottom repeat-x;padding: 5px 10px 5px 10px;text-decoration: none;
            ...
            <div id="top-menu">
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a class="menu" href="UserAuthenticate.jsp">User Authenticate</a></li>
                  
                  <li style="background-color: #3399ff;"> <a href="#">Cloud Services</a>
                  
                  
    <ul> 
     <li><a href="UserAvailability.jsp">User Availability</a></li>
  <li><a href="WorkLoad.jsp">WorkLoad</a></li> 
 
  <li><a href="AssignWorkSchedule.jsp">Send Available Work</a></li> 
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
   &nbsp; &nbsp;
 <marquee rotate="alternative"><h3>WELCOME::: ADMIN</h3></marquee>
