              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  <li><a class="menu" href="index.jsp">Home</a></li>
                   <li><a class="menu" href="UserRegistration.jsp">Registration</a></li>
...
<div class="templatemo_servicewrapper" id="templatemo_service_page">
  <div class="container">
    <div class="row">
 <h3 style="color: navy;">User Login</h3>
  ...
  <div style="color: green;"> UserID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="Userid"  placeholder="User Id" ><br></div> 
    <div style="color: green;">Password:&nbsp;&nbsp;<input type="password" name="Psssword" placeholder="PassWord"><br></div> 
   
  <div style="color: green;">  &nbsp; &nbsp; &nbsp; &nbsp;<input type="submit" value="SUBMIT"> <a href="UserRegistration.jsp">New Register?</div></a>
