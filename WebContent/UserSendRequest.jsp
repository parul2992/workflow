    ...
    <div class="container">
      <div class="row">
        <div class="templatemo_titlewrapper"><img src="images/templatemo_logobg.png" alt="logo background">
          <div class="templatemo_title"><span>USER REQUEST</span></div>
        </div>
        <div class="clear"></div>
...
<!--                   <li><a class="menu" href="#templatemo_service_page">Send Request</a></li> -->
                  <li><a class="menu" href="UserWelcomepage.jsp">Back</a></li>
...
<div class="templatemo_team_wrapper" id="templatemo_team_page">
  <div class="container">
    ...
    <h1>WELLCOME ::: <%=session.getAttribute("Uname") %> </h1>
     
     <center> <table>
     <th> UserID: &nbsp; &nbsp;</th><td><%=session.getAttribute("Uid") %></td>
      </table></center>
      
      <form action="UserWellcomepage" method="post">
    ...
    <option value="America">America</option>
      ...
      District:<select name="District"> <option >Select</option>
    <option value="Prakasam">Prakasam</option>
    <option value="Warangal">Warangal</option>
    <option value="Karnul">Karnul</option>
    <option value="Nellure">Nellure</option>
</select><br><br>
...
<!--       Cash:  <input type="text" name="cash" id="cash">        <br> -->
     ...
     <p><font face="verdana" color="green"><h4> <marquee scrollamount="5" width="40">&lt;&lt;&lt;</marquee>CARD DETAILS<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></h4></font>
    ...
    Branch Name:<input type="text" name="branchname"><br>
      ...
      A/C No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="a/cno"><br>
