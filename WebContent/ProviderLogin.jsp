            ...
            <div id="top-menu">
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a class="menu" href="ProviderLogin.jsp"> Back</a></li>
                  <li><a class="menu" href="#templatemo_worke"></a></li>
                  <li><a class="menu" href="#templatemo_team_page"></a></li>
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
   &nbsp; &nbsp;
  <font face="verdana" color="blue"><h3>Provider Login</h3></font>
...
<br>
<br> 
 Provider Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Pname" Placeholder="Provider Name"><br><br>
 Provider Password:<input type="password" name="Ppwd" Placeholder="Provider Password"><br><br>
