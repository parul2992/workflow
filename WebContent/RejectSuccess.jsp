...
<!--  <h3>WELCOME::: ADMIN</h3> -->
  ...
  <h1>USER DETAILS</h1>
      ...
      <br>
			...
			PreparedStatement ps=(PreparedStatement)c.prepareStatement("SELECT * FROM `workflowscheduling`.`userregistration` where status='reject'");
...
<%--                     <td style="position:relative;background-color:#00CED1"> <td><%=status %>	</td> --%>
                    <td style="position:relative;background-color:#DB7093">	<%=status%></td>
